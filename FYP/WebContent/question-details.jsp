					...
					<!-- START CODING FROM HERE  -->
						...
						<table class="comments-results-area">
							...
							<tr class="comments-odd">
							 	...
							 	<td class="comment-name-text"><a href="#"><span class="comment-name">Ian Chan:</span></a>Thanks Alvin! Just want to say that you're the most helpful person in planet earth. Can I give you a big kiss? - 3 days ago</td>
						 	</tr>
						 	<tr class="comments-even">
							  	<td class="avatar"></td> <!--  Left Empty -->
							 	<td class="comment-name-text"><a href="#"><span class="comment-name">Jeremy Zhong:</span></a>Thanks! But what are the required documents! I heard frmo my friends that I only need my Identification Card (IC). Is that right? - 2 days ago</td>
						 	</tr>				
						 	<tr class="comments-odd">
							  	<td class="avatar"></td> <!--  Left Empty -->
							 	<td class="comment-name-text"><a href="#"><span class="comment-name">Xiang Rui:</span></a> It took me more than 2 weeks. - 5 mins ago</td>
						 	</tr>
						 	<!-- END OF COMMENTS -->
						 	<tr>
						 		<td></td> <!-- Left Empty -->
